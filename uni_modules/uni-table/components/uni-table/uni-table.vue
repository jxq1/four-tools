	...
	<view class="uni-table-scroll" :class="{ 'table--border': border, 'border-none': !noData }">
		...
		<table class="uni-table" border="0" cellpadding="0" cellspacing="0" :class="{ 'table--stripe': stripe }">
			...
			<view v-if="noData" class="uni-table-loading">
				...
				<image class="uni-table-text" :class="{ 'empty-border': border }" src="./表格无数据.png" mode=""></image>
			</view>
...
export default {
	...
	methods: {
		isNodata() {
			...
			// console.log("theadchilren",this.theadChildren)
			// console.log("trchilren",this.trChildren)
			this.noData = this.trChildren.length - rowspan <0
			// console.log("noData1",this.noData)
		},
		/**
		 * 选中所有
		 */
...
.uni-table {
	...
	table-layout: fixed;
	// TABLE-LAYOUT:fixed;
	::v-deep .uni-table-tr:nth-child(n + 1) {
		&:hover {
...
.table--stripe {
	/* #ifndef APP-NVUE */
	::v-deep .uni-table-tr:nth-child(2n + 2) {
